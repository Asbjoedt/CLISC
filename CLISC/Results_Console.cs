...
namespace CLISC
{
    public partial class Results
    {
        ...
        public void Archive_Results()
        {
            ...
            //Console.WriteLine($"ARCHIVE: {Archive.metadata_files} of {Conversion.numCOMPLETE} converted spreadsheets had file property information");
            ...
            Console.WriteLine($"ARCHIVE: {Archive.embedobj_files} of {Conversion.numCOMPLETE} converted spreadsheets have embedded objects  - Embedded objects were converted to TIFF");
